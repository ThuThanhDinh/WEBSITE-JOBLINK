...
const ManageJobAdmin = () => {
  ...
  const listJob = useSelector((state) => state.recruiter.listJob); // Assumes you have a job reducer managing listJob state
            ...
            {listJob?.length > 0 ? (
              listJob.map((item) => (
                ...
                >
                  ...
                  <td className="pl-10 px-6 py-4 text-center">
                    <button
